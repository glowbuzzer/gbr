...
import { Button, Flex, Space, Row, Col, Card, Checkbox } from "antd"
...
export const GbemOptionalSlavesTab = () => {
    return (
        <Space direction="vertical" size="large" style={{ width: "100%" }}>
            <div style={{ textAlign: "left", fontSize: "14px" }}>Select slaves to enable</div>
            <SlaveGrid2 />
        </Space>
    )
}
