...
const emStatSafetyDictionary: DictionaryNode = {
    type: "object",
    children: {
        fsoesc: {
...
export function toTableDataEmStatSafety(
    obj,
    parentKey = "",
    dict: DictionaryNode | undefined = emStatSafetyDictionary
) {
    const result = []
    const validKeys = extractValidKeys(emStatSafetyDictionary)
