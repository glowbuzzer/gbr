...
export class MotorDro extends React.PureComponent<MotorProps> {
    ...
    render() {
        this.update();
        return <svg ref={this.assign} width={this.props.width} version="1.1" viewBox="0 0 200 200"
            ...
            <g transform="translate(100,100)">
                <g id="spinner">
                    <path d="m0 10h75" fill="none" stroke="#D39900" strokeLinecap="round" strokeWidth="8"/>
