...
const _BitFieldDisplay = (props: BitFieldDisplayProps) => {
                ...
                <div key={group_num}>
                    {g.map((b, bit_num) => (
                        <div key={bit_num} onClick={() => toggle(group_num, bit_num)} className={"bit-item" + (props.editable ? " rw" : "")}>
                            ...
                            <div
                                className={"bit " + (test_bit(group_num, bit_num) ? "bit-set " : "") + (props.editable ? "" : " bit-readonly ")}
                            ></div>
                        </div>
                    ))}
                </div>
...
export const BitFieldDisplay = styled(_BitFieldDisplay)`
    .bit-item {
