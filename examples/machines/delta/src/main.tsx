...
const DeltaRobot = () => {
    ...
    // TODO: I've added these to avoid compile errors - needs fixing
    const baseTriangleLength = 0
    const effectorTriangleLength = 0
    const upperLinkLength = 0
...
root.render(
    <StrictMode>
        <GlowbuzzerApp appName="delta" configuration={config}>
            <App />
        </GlowbuzzerApp>
    </StrictMode>
)
