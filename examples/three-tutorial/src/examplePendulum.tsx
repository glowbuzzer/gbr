...
import {useConnection, useFrames, useKinematicsCartesianPosition, useIntegerOutputState} from "@glowbuzzer/store";
    ...
    return(
        <>
            <Html style={{
                ...
                <h1>Example 11 - moving an object with a integer input value (set value of integer output #0 to see</h1></Html>

            <group ref={pendulumGroup} position={[500,500,500]}>
            <Cylinder ref={shaftRef} args={[10,10,500,64]} position={[0,0,-500/2]} rotation={[Math.PI/2,0,0]} >
