...
function Scene() {
    ...
    return (
        <>
            <spotLight castShadow position={[0, 0, 1000]} ref={spotLight} angle={0.5} color={"yellow"} distance={1200} />
        ...
        <>
            <StyledApp>
                ...
                <div className="body">
                    ...
                    <section>
                        <ToolPathTile model={showRobot && TX40_MODEL} getExtent={maxExtent} noLighting={false} noControls={false} noViewCube={false} noCamera={false}>
          {/*<ExampleLighting/>*/}
          {/*                  <ExampleSphere/>*/}
                            {/*<ExampleBox/>*/}
                            {/*<Plane*/}
