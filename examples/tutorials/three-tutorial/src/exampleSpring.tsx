...
function SwitchModel(props) {
    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh
                geometry={switchSphere.geometry}
                material={materials.sphere}
                position={[0, 0.85, -1.41]}
            />
        </group>
    )
}
...
export const ExampleSpring = () => {
    ...
    const [{ x }] = useSpring(
        { x: toggle, config: { mass: 5, tension: 300, friction: 50, precision: 0.0001 } },
        [toggle]
    )
    ...
    return (
        <>
            ...
            >
                <h1>Example 14 - using springs to create interactive controls</h1>
            </Html>
