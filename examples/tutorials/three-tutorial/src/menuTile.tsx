...
export const ChooseExample = props => {
    ...
    return (
        <StyledDiv>
            ...
            <div className="row">
                <p>
                    (1) = adding a sphere, (2) = moving box with texture, (3) = spotlight on object,
                    (4) = physics, demolish dominoes, (5) = sprites and text
                </p>
            </div>
            <div className="row">
            ...
            <div className="row">
                <p>
                    (6) = Show object co-ordinates, (7) = Move object in scene, (8) = Object
                    collision detection, (9) = Points from config, 10 = Examaple UI
                </p>
            </div>
            <div className="row">
            ...
            <div className="row">
                <p>
                    (11) = object position from encoder, (12) = modelling a gripper, (13) = digital
                    inputs display, (14) = using springs to create interactive controls, (15) =
                    laser cutting{" "}
                </p>
            </div>
        </StyledDiv>
