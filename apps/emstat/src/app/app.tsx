    ...
    for (let i = 0; i < constJSON?.number_of_drives; i++) {
        ...
        driveTree[i].children.push({
            title: (
                <span>
                    Actual position:{" "}
                    <Text code>{statusJSON?.drives[i].actpos.toLocaleString()}</Text>
                </span>
            ),
            key: "" + keyCount++
        })
        ...
        slaveTree[i].children.push({
            title: (
                <span>
                    ...
                    <Text code>{slaveStateMapper(statusJSON?.slaves[i].state)}</Text>
                </span>
            ),
            key: "" + keyCount++
        })
                    ...
                    <Row gutter={16}>
                        <Col className="gutter-row" span={11}>
                            ...
                            <div>
                                <span>
                                    Machine status word:{" "}
                                    <Text code>{emstat_status_result?.machine_status_word}</Text>
                                </span>
                            </div>
                            <div>
                                <span>
                                    Machine control word (CiA 402):{" "}
                                    <Text code>{emstat_status_result?.machine_control_word}</Text>
                                </span>
                            </div>
                            <div>
                                <span>
                                    Shared memory connection established:{" "}
                                    <Text code>{emstat_status_result?.gbc_connected}</Text>{" "}
                                </span>
                            </div>
                            <div>
                                <Tooltip
                                    placement="top"
                                    title="Heartbeat IN is generated by GBEM and is sent to GBC"
                                >
                                    Heartbeat IN:{" "}
                                    <span>
                            ...
                            <div>
                                ...
                                >
                                    Heartbeat OUT:{" "}
                                    <Text code>{emstat_status_result?.heartbeat_out}</Text>
                                </Tooltip>
                            </div>
                            <div>
                                <span>
                                    EtherCAT error:{" "}
                                    <Text code>{emstat_status_result?.ecat_error}</Text>
                                </span>
                            </div>
                            <div>
                                <Tooltip
                        ...
                        <Col className="gutter-row" span={11}>
                            <Tooltip
                                placement="left"
                                title="Shows faults currently active on the machine"
                            >
                                <p>
                ...
                <Card title="Slave & Drive status">
                    <Row gutter={16}>
                        <Col className="gutter-row" span={11}>
                            ...
                            <div style={style}>
                                Number of slaves found on EtherCAT network:{" "}
                                {emstat_const_result?.number_of_slaves}
                            </div>
                        </Col>
                        <Col className="gutter-row" span={11}>
                            <div style={style}>
                            ...
                            <div style={style}>
                                Number of drives found on EtherCAT network:{" "}
                                {emstat_const_result?.number_of_drives}
                            </div>
                        </Col>
                    </Row>
                    <Row gutter={16}>
                ...
                <Card title="Digital Analogue Integer in/out status">
                    <Row gutter={16}>
                        <Col className="gutter-row" span={11}>
                            ...
                            <div>
                                Number of Digital Ins defined in GBEM{" "}
                                <Text underline>MAP_NUM_DIGITAL_IN</Text> is:{" "}
                            ...
                            <div>
                                Number of Digital Outs defined in GBEM{" "}
                                <Text underline>MAP_NUM_DIGITAL_OUT</Text> is:{" "}
                        ...
                        <Col className="gutter-row" span={11}>
                            ...
                            <div>
                                Number of Integer Ins defined in GBEM{" "}
                                <Text underline>MAP_NUM_INTEGER_IN</Text> is:{" "}
                            ...
                            <div>
                                Number of Integer Outs defined in GBEM{" "}
                                <Text underline>MAP_NUM_INTEGER_OUT</Text> is:{" "}
                            ...
                            <div>
                                Number of Float Ins defined in GBEM{" "}
                                <Text underline>MAP_NUM_FLOAT_IN</Text> is:{" "}
                            ...
                            <div>
                                Number of Float Outs defined in GBEM{" "}
                                <Text underline>MAP_NUM_FLOAT_OUT</Text> is:{" "}
