...
//
// /*
// const TestLine = React.forwardRef<Line2, any>(function Line(
//     { points, drawLimit, color = "black", vertexColors, lineWidth, dashed, ...rest },
//     ref
// ) {
...
//             <gridHelper
//                 args={[2 * extent, 20, undefined, 0xc0c0c0]}
//                 rotation={new Euler(Math.PI / 2)}
//             />
//             <axesHelper args={[extent / 10]} position={new Vector3(-extent, -extent, 0)} />
//             {points.length > 1 && (
//                 <TestLine points={points} linewidth={2} drawLimit={points.length} color="red" />
//             )}
//         </>
//     )
// }
...
//             return [
//                 extent * Math.sin(angle * x_period),
//                 extent * Math.cos(angle * y_period),
//                 extent * Math.cos(angle * z_period)
//             ] // toVector3(point)
//         })
//     }
//
